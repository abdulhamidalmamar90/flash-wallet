  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-8 animate-in fade-in slide-in-from-top-4 duration-700 pb-32">
      ...
      <Tabs defaultValue="withdrawals" className="w-full">
        <TabsList className="grid w-full grid-cols-4 sm:grid-cols-5 h-auto bg-card/40 border border-white/5 rounded-2xl mb-8 p-1 gap-1 overflow-x-auto">
                  ...
                  {archivedSessions.length === 0 ? (
                    ...
                    <div key={s.id} onClick={() => handleOpenArchive(s)} className="w-full p-3 border-b border-white/5 text-left transition-all hover:bg-white/5 flex justify-between items-center group cursor-pointer">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={(e) => handleDeleteArchive(e, s.id)} className="p-1.5 hover:bg-red-500/20 text-muted-foreground hover:text-red-500 rounded-lg transition-all opacity-0 group-hover:opacity-100">
                          <Trash size={10} />
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6 animate-in fade-in zoom-in-95">
                    ...
                    {(selectedArchive.rating || selectedArchive.feedback) && (
                      <div className="p-4 bg-green-500/5 border border-green-500/20 rounded-2xl space-y-3">
                        ...
                        {selectedArchive.feedback && (
                          <p className="text-[10px] font-headline text-white/60 italic leading-relaxed border-t border-white/5 pt-2">
                            "{selectedArchive.feedback}"
                          </p>
                        )}
                      </div>
